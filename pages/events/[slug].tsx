  ...
  return (
    <div>
      ...
      <main>
        ...
        <p className="text-xl py-2 px-2">Possible timeframes:</p>
        <p className="text-xl py-2 px-2">-</p>
        <p className="text-xl py-2 px-2">Excluded timeframes:</p>
        <p className="text-xl py-2 px-2">-</p>
        <p className="text-xl py-2 px-2">Repeats:</p>
        <p className="text-xl py-2 px-2">-</p>
        <p className="text-xl py-2 px-2">Members - token:</p>
        <p className="text-xl py-2 px-2">John Smith - firsttesttoken</p>
        <p className="text-xl py-2 px-2">Eva Novak - secondtesttoken</p>
      </main>
    </div>
  );
}
